      ...
      <CardBody className="text-center">
        ...
        <section className="text-left pt-2">
          ...
          <div className="ml-1 mt-2">
            <Switch onChange={() => {setCustomNoti(!customNoti); reset()}} color="indigo" id="auto-update" label="Notificacion Personalizada"/>
          </div>
          <form>
            {customNoti && 
            <section className="py-2">
              <div className="mb-3">
                <Input {...register("title", {required : true})} className='mx-auto' color='purple' variant='outlined' label='Titulo' size='lg'/>
              </div>
              <div className="mb-3">
      ...
      <Dialog open={open} handler={handleOpen}>
        ...
        <DialogBody>
          <section className="text-xl">
            <p>
              Al dar click confirmar, mandaras una notificacion a todos los usuarios de la aplicacion. 
              <span className="text-bold text-pink-400"> Esta accion es irreversible</span>
            </p>
          </section>
        </DialogBody>
        <DialogFooter>
